...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'picEdit',
        defaults = {
            ...
            fileNameChanged: function(filename){},  // After filename is changed
    ...
    Plugin.prototype = {
        init: function () {
                ...
                if(type == "file") this._fileinput = $(this.inputelement);
                else {
        ...
        set_loading: function (message) {
            if(message && message == 1) return this.set_messagebox("Working...", false, false);
